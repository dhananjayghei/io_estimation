...
\begin{table}[htbp!]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{lrrrrr}
      ...
      Confidence interval & {[}-1.61, 15.221{]} & {[}-1.194, 21.751{]} & {[}-0.975, 11.479{]} & {[}-2.825, 29.471{]} & {[}-23.562, 192.553{]}\\
      \hline
    \end{tabular}}
...
\begin{table}[htbp!]
  ...
  \begin{tabular}{lrrrrr}
    ...
    & {[} NA, 10.151 {]} & {[}-0.507, 15.387{]} & {[}-0.267, 8.551{]} & {[}-0.234, 20.891{]} & {[}-17.423, 392.691{]} \\
    Germany & {[}0.271, 1.742{]} & {[}0.0, 2.267{]} & {[}0.349, 1.432{]} & {[}0.23, 2.328{]} & {[}26.381, 38.407{]} \\
    & {[}-0.483, 13.529{]} & {[}NA, 10.073{]} & {[}-0.375, 8.812{]} & {[}-0.562, 21.558{]} & {[}-24.019, 250.719{]} \\
    Spain & {[}0.123, 1.381{]} & {[}0.099, 0.959{]} & {[}0.0, 0.939{]} & {[}0.094, 1.217{]} & {[}1.591, 21.227{]} \\
    & {[}-0.38, 20.141{]} & {[}-0.411, 11.789{]} & {[}NA, 4.325{]} & {[}-0.221, 16.117{]} & {[}-8.269, 231,428{]} \\
    UK & {[}0.21, 3.976{]} & {[}0.169, 5.019{]} & {[}0.158, 2.586{]} & {[}0.0, 2.396{]} & {[}6.683, 47.173{]} \\
    & {[}-0.561, 29.971{]} & {[}-0.461, 43.08{]} & {[}-0.34, 15.319{]} & {[}NA, 15.698{]} & {[}-11.701, 305.055{]} \\
    US & {[}0.865, 5.078{]} & {[}0.873, 5.204{]} & {[}0.974, 4.11{]} & {[}2.494, 8.527{]} & {[}0.0, 54.242{]} \\
    & {[}-4.451, 16.651{]} & {[}-6.341, 16.399{]} & {[}-5.012, 10.112{]} & {[}-20.314, 22.419{]} & {[}NA, 96.179{]}\\
    \hline
  \end{tabular}}
